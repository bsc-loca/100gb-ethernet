...
if { ${g_dma_mem} eq "sram" } {
  ...
  connect_bd_intf_net [get_bd_intf_ports m_axi_rx] [get_bd_intf_pins axi_reg_slice_rx/M_AXI]
  connect_bd_intf_net [get_bd_intf_ports m_axi_tx] [get_bd_intf_pins axi_reg_slice_tx/M_AXI]
