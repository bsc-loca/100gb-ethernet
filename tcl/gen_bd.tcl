...
to avoid the SC shutting down the card (UG1314)" [get_bd_ports /HBM_CATTRIP]
  ...
  connect_bd_net -net resetn_inv_0_Res [get_bd_pins clk_wiz_1/reset] [get_bd_pins cmac_usplus_0/gtwiz_reset_rx_datapath] [get_bd_pins cmac_usplus_0/gtwiz_reset_tx_datapath] [get_bd_pins resetn_inv_0/Res]
