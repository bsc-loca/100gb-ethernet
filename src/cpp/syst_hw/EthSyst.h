...
class EthSyst {
  ...
  // uint32_t* sysMem = reinterpret_cast<uint32_t*>(0x40000000); // system mem (DDR/HBM) base address
  uint32_t* sysMem = reinterpret_cast<uint32_t*>(XPAR_HBM_0_BASEADDR); // system mem (DDR/HBM) base address
