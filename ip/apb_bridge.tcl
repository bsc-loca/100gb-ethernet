...
set_property -dict [list CONFIG.C_ADDR_WIDTH $AxiAddrWidth ] [get_ips axi_apb_bridge_0]

# Create some flexibility in case the user wants to access the UART with a different AXI bus width
