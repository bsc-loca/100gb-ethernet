...
# The script should be run with activated Xilinx environment (last updated for Vitis/Vivado-2025.2) and RISCV toolchain with enabled cross-compilation for Linux.
...
cp $XILINX_VITIS/data/embeddedsw/XilinxProcessorIPLib/drivers/axidma_v9_20/src/xaxidma_g.c ./
cp $XILINX_VITIS/data/embeddedsw/XilinxProcessorIPLib/drivers/axidma_v9_20/src/xaxidma_bdring.c ../cpp/syst_hw/
...
then
  ...
  then
    ...
    DEF_DMA_MEM_HBM="-DAURORA -DDMA_MEM_HBM"
     ...
     grep -s "set g_dma_mem" ../../../../scripts/gen_project.tcl
then
  if grep -s "ETHERNET,yes.*sram" ../../../../accelerator/meep_shell/accelerator_def.csv ||
     ...
     grep -s "set g_dma_mem.*sram" ../../../../scripts/gen_project.tcl
  then
    ...
    DEF_DMA_MEM_HBM=""
       ...
       grep -s "set g_dma_mem.*AXI4" ../../../../scripts/gen_project.tcl
  then
...
riscv64-unknown-linux-gnu-gcc -Wall -O0 -g -march=rv64g -D__aarch64__ $DEF_DMA_MEM_HBM -o ./eth_test \
                              ...
                              -I$XILINX_VITIS/data/embeddedsw/lib/bsp/standalone_v9_4/src/common \
                              -I$XILINX_VITIS/data/embeddedsw/lib/bsp/standalone_v9_4/src/riscv \
                              -I$XILINX_VITIS/data/embeddedsw/XilinxProcessorIPLib/drivers/tmrctr_v4_14/src \
                              -I$XILINX_VITIS/data/embeddedsw/XilinxProcessorIPLib/drivers/axidma_v9_20/src \
                              ...
                              -I$XILINX_VITIS/data/embeddedsw/XilinxProcessorIPLib/drivers/axis_switch_v1_7/src \
                                $XILINX_VITIS/data/embeddedsw/lib/bsp/standalone_v9_4/src/common/xil_assert.c \
                                $XILINX_VITIS/data/embeddedsw/XilinxProcessorIPLib/drivers/tmrctr_v4_14/src/xtmrctr.c \
                                $XILINX_VITIS/data/embeddedsw/XilinxProcessorIPLib/drivers/tmrctr_v4_14/src/xtmrctr_l.c \
                                $XILINX_VITIS/data/embeddedsw/XilinxProcessorIPLib/drivers/tmrctr_v4_14/src/xtmrctr_sinit.c \
                                $XILINX_VITIS/data/embeddedsw/XilinxProcessorIPLib/drivers/tmrctr_v4_14/src/xtmrctr_selftest.c \
                                $XILINX_VITIS/data/embeddedsw/XilinxProcessorIPLib/drivers/tmrctr_v4_14/src/xtmrctr_g.c \
                                $XILINX_VITIS/data/embeddedsw/XilinxProcessorIPLib/drivers/axidma_v9_20/src/xaxidma.c \
                                $XILINX_VITIS/data/embeddedsw/XilinxProcessorIPLib/drivers/axidma_v9_20/src/xaxidma_bd.c \
                                $XILINX_VITIS/data/embeddedsw/XilinxProcessorIPLib/drivers/axidma_v9_20/src/xaxidma_sinit.c \
                                $XILINX_VITIS/data/embeddedsw/XilinxProcessorIPLib/drivers/axidma_v9_20/src/xaxidma_selftest.c \
                                ./xaxidma_g.c \
